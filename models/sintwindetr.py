...
class SinTwinDetr(nn.Module):
    def __init__(self, num_classes, hidden_dim=256, nheads=8,
                 num_encoder_layers=6, num_decoder_layers=6):

        super(SinTwinDetr, self).__init__()
        ...
        self.linear_class = SinLayer(hidden_dim, 128, num_classes + 1) #nn.Linear(hidden_dim, num_classes + 1)
        self.linear_bbox = SinLayer(hidden_dim, 128, 4) #nn.Linear(hidden_dim, 4)
